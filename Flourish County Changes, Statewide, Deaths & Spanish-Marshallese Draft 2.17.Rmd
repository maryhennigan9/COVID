...
write.csv(homepage_marshallese, file = "SpanishData/homepage_marshallese.csv")
```
...
countyonlytoday_marshallese <- countyonlytoday %>% 
  rename(Case_ko_rōkāāl_rainin = New_Cases_Today, Armej_ro_rej_kab_mej_rainin = New_Deaths_Today, Oran_case_ko_rej_active  = Active_Cases, Keej_ko_rej_Active_iaan_10K_armej  = Active_Cases_10k_Pop, Confirmado_Activo = confirmed_active, Probable_Activo = probable_active,  Nuevos_Casos_Hoy_por_cada_10k_Residentes = New_Cases_Today_10k_Pop, Población_Probada = Tested_Population)
#countyonlytoday_spanish <- countyonlytoday_spanish [ -c(1) ]

write.csv(countyonlytoday_marshallese, file = "SpanishData/countyonlytoday_marshallese.csv")
...
Top_counties_new_cases_marshallese <- Top_counties_new_cases %>% 
  rename( Case_ko_rōkāāl_rainin  = New_Cases_Today, Nuevos_Casos_por_cada_10k_Residentes = New_Cases_Today_10k_Pop)


write.csv(Top_counties_new_cases_marshallese, file = "SpanishData/Top_counties_new_cases_marshallese.csv")
...
write.csv(deaths_daily_marshallese, file = "SpanishData/deaths_daily_marshallese.csv")
```
...
write.csv(countysnapshot_marshallese, file = "SpanishData/countysnapshot_marshallese.csv")
...
write.csv(datawrapper_marshallese, file = "SpanishData/datawrapper_marshallese.csv")
```
